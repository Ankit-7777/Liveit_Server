"""
Django settings for Liveit_Server project.
...
SECRET_KEY = 'django-insecure-hy+2=!k)@!f2lq3!s^e7-5+bm@v*qqehuknf3^wk4*heuht)1o'
...
ROOT_URLCONF = 'Liveit_Server.urls'
...
WSGI_APPLICATION = 'Liveit_Server.wsgi.application'
ASGI_APPLICATION = 'Liveit_Server.asgi.application'
